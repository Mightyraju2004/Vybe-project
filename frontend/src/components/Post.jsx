  ...
  return (
    <div className='w-[90%]   flex flex-col gap-[10px] bg-white items-center shadow-2xl shadow-[#00000058] rounded-2xl pb-[20px]'>
      <div className='w-full h-[80px] flex justify-between items-center px-[10px]'>
       ...
       {userData._id===post.author._id && <button onClick={handleDelete} className='text-red-600 hover:text-red-400 text-sm flex items-center gap-1'><MdDelete className='w-[20px] h-[20px]' />Delete</button>}
      </div>
